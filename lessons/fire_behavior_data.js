...
const examQuestions = [
    { q: "What defines a rapid oxidation chemical reaction that produces heat and visible light?", opts: ["Fire", "Convection", "Entrainment", "Radiation"], ans: 0, coaching: "Fire can be defined simply as a rapid oxidation (chemical) reaction that produces heat and visible light." },
    { q: "Which element of the fire tetrahedron is normally atmospheric oxygen?", opts: ["Oxidizing agent", "Fuel", "Heat", "Uninhibited chemical chain reaction"], ans: 0, coaching: "The oxidizing agent is normally atmospheric oxygen, but may also be chemical compounds known as oxidizers." },
    { q: "What method of heat transfer occurs through electromagnetic waves?", opts: ["Radiation", "Conduction", "Convection", "Bi-directional flow"], ans: 0, coaching: "Radiation is the transfer of heat through electromagnetic waves." },
    { q: "Which of the following describes heat moving through direct contact within an object or between objects?", opts: ["Conduction", "Convection", "Radiation", "Autoexposure"], ans: 0, coaching: "Conduction is the transfer of heat within an object or between objects through direct contact." },
    { q: "What phenomenon occurs when a heated combustible material ignites from an applied flame or spark?", opts: ["Piloted ignition", "Autoignition", "Flameover", "Backdraft"], ans: 0, coaching: "Piloted ignition is the ignition of a heated combustible material when a flame or spark is applied." },
    { q: "What term describes the vertical spread of fire on the exterior of a multistory building?", opts: ["Autoexposure", "Entrainment", "Rollover", "Conduction"], ans: 0, coaching: "Autoexposure describes the vertical spread of fire on the exterior of a multistory building, from one floor to the floor above." },
    { q: "Which stage of a compartment fire is the initial stage following ignition, usually involving a small number of combustibles?", opts: ["Incipient", "Free burning", "Flashover", "Smoldering/decay"], ans: 0, coaching: "Incipient is the initial stage of a fire after ignition, usually involving a single or small number of combustibles." },
    { q: "In what stage of a fire does glowing combustion take place without flame due to limited oxygen?", opts: ["Smoldering/decay", "Incipient", "Free burning", "Flashover"], ans: 0, coaching: "Smoldering/decay is a stage in which glowing combustion takes place, without flame, often when oxygen is limited." },
    { q: "What term describes fresh air being drawn into the fire from the doorway?", opts: ["Entrainment", "Flameover", "Conduction", "Flashover"], ans: 0, coaching: "Fresh air is drawn into the fire from the doorway and is drawn into the fire itself; this is known as entrainment." },
    { q: "What defines the interface between the hot ceiling layer and the cooler air flowing into the compartment?", opts: ["Neutral plane", "Fire plume", "Flow path", "Bi-directional flow"], ans: 0, coaching: "The neutral plane is the interface between the hot ceiling layer and the cooler air flowing into the compartment." },
    { q: "When hot unburned fuel gases gather at the ceiling layer and suddenly ignite, what has occurred?", opts: ["Flameover (Rollover)", "Backdraft", "Autoexposure", "Convection"], ans: 0, coaching: "In flameover (or rollover), hot unburned fuel gases at the ceiling layer suddenly ignite." },
    { q: "What describes the movement of hot fire gases and smoke from areas of high pressure to low pressure?", opts: ["Flow path", "Neutral plane", "Conduction", "Entrainment"], ans: 0, coaching: "Flow paths are the movement of hot fire gases/smoke from areas of high pressure to low pressure." },
    { q: "What occurs when oxygen is introduced to a fire environment where the oxygen supply was previously depleted?", opts: ["Backdraft", "Autoignition", "Flameover", "Bi-directional flow"], ans: 0, coaching: "Backdraft occurs when heated gaseous products of combustion burn when oxygen is introduced into an oxygen-depleted environment." },
    ...
    { q: "What specific hazard is created when remodeling a building by installing a new dropped ceiling below an older combustible ceiling?", opts: ["A dangerous concealed void space is created where fire can burn undetected", "The neutral plane is permanently lowered", "The fire plume is restricted from vertical movement", "Carbon monoxide is prevented from stratifying"], ans: 0, coaching: "When the new fire-rated ceiling is installed below the old ceiling, the dangerous combustible ceiling is left above, creating a concealed void where fire can burst down." },
    { q: "What gives smoke its characteristic opaqueness?", opts: ["Solid particulates, primarily carbon", "Colorless carbon monoxide gas", "Vaporized unburned fuel gases", "Atmospheric oxygen"], ans: 0, coaching: "The solid particulates—typically carbon—give smoke its opaqueness." },
    { q: "Which toxic fire gas is also highly flammable and can accumulate in confined areas to ignite or explode?", opts: ["Carbon Monoxide (CO)", "Nitrous Oxide", "Polychlorinated biphenyl (PCB)", "Polyvinyl chloride (PVC)"], ans: 0, coaching: "CO is the most prevalent toxic fire gas, and it is also a flammable gas that can ignite or explode in confined areas." },
    { q: "Which of the following describes Haber’s rule for toxic exposure?", opts: ["Concentration (in ppm) multiplied by minutes exposed equals 33,000 is likely to be dangerous", "10-minute exposure to 3500 ppm of CO is standard and safe", "Toxicity decreases as the temperature of the fire plume increases", "Carbon monoxide stratifies only above the neutral plane"], ans: 0, coaching: "Haber’s rule states that any exposure in which the concentration (in ppm) × minutes exposed equals 33,000 is likely to be dangerous." },
    { q: "What contemporary material, commonly used as an electrical insulator, emits highly toxic gases when it burns?", opts: ["Polyvinyl chloride (PVC)", "Low-density fiberboard", "Combustible acoustical tile", "Glass fiber insulation"], ans: 0, coaching: "Polyvinyl chloride (PVC) is an effective electrical insulator... When it burns, however, it emits toxic gases." },
    { q: "What toxic chemicals were historically used as nonflammable coolants in electrical transformers and pose a massive hazard if released during a fire?", opts: ["Polychlorinated biphenyls (PCBs)", "Hydrogen Cyanide (HCN)", "Nitrous Oxide", "Carbon Dioxide (CO2)"], ans: 0, coaching: "PCBs were used as nonflammable coolants in transformers. They release toxic by-products into the atmosphere when exposed to fire." }
];
