...
const examQuestions = [
    ...
    { q: "When a wooden floor joist bows, the actual physical, visible deformation is known as:", opts: ["Torsion", "Strain", "Stress", "Shear"], ans: 1 , topic: "Building Construction"},
    { q: "A massive HVAC unit permanently bolted to a roof is an example of what type of load?", opts: ["Dead Load", "Live Load", "Impact Load", "Lateral Load"], ans: 0, topic: "Building Construction" },
    { q: "When a master stream adds over 4 tons of water weight per minute to a structure, this rapidly accumulating weight is a:", opts: ["Live Load", "Dead Load", "Impact Load", "Lateral Load"], ans: 0, topic: "Building Construction" },
    { q: "High winds pushing against the broad side of a structure create what type of load?", opts: ["Axial Load", "Live Load", "Impact Load", "Lateral Load"], ans: 3, topic: "Building Construction" },
    { q: "A sudden, violent force delivered in a short time, such as a partial roof collapse onto a lower floor, is a(n):", opts: ["Eccentric Load", "Impact Load", "Lateral Load", "Concentrated Dead Load"], ans: 1, topic: "Building Construction" },
    { q: "A force that passes straight through the centroid of a material, distributing stress evenly, is an:", opts: ["Axial Load", "Eccentric Load", "Impact Load", "Torsional Load"], ans: 0, topic: "Building Construction" },
    { q: "A weight placed off-center on a pillar, which induces a bending stress, is called an:", opts: ["Axial Load", "Concentrated Load", "Eccentric Load", "Uniformly Distributed Load"], ans: 2, topic: "Building Construction" },
    { q: "Water sitting evenly across a flat roof is an example of what type of load application?", opts: ["Concentrated Load", "Eccentric Load", "Axial Load", "Uniformly Distributed Load"], ans: 3, topic: "Building Construction" },
    { q: "What term represents the total amount of potential energy (heat) available to burn in a given space?", opts: ["Heat Release Rate", "Fire Load", "Safety Factor", "Live Load"], ans: 1, topic: "Building Construction" },
    { q: "Modern plastics and polyurethane foams contain approximately how many BTUs per pound?", opts: ["8,000", "12,000", "16,000", "24,000"], ans: 2, topic: "Building Construction" },
    { q: "If 5 pounds of solid heavy timber is turned into thin wood chips, what changes drastically?", opts: ["The dead load of the material", "The total Fire Load (BTUs)", "The safety factor of the wood", "The Heat Release Rate (HRR)"], ans: 3, topic: "Building Construction" },
    { q: "Ordinary combustibles like wood and paper hold approximately how many BTUs per pound?", opts: ["8,000", "16,000", "24,000", "32,000"], ans: 0, topic: "Building Construction" },
    { q: "The built-in buffer that is the ratio between a material's ultimate breaking strength and its safe working stress is the:", opts: ["Elastic limit", "Safety Factor", "Heat Release Rate", "Torsional threshold"], ans: 1, topic: "Building Construction" },
    { q: "Why does field-constructed masonry require a much higher safety factor (e.g., 10) than factory-produced steel (e.g., 2)?", opts: ["It is inherently heavier.", "It has a lower melting point.", "It has significantly more unknown variables.", "It lacks compression strength."], ans: 2, topic: "Building Construction" },
    { q: "In reinforced concrete, what specific weakness of the concrete is the embedded steel rebar designed to compensate for?", opts: ["Concrete's weakness in compression", "Concrete's vulnerability to shear forces", "Concrete's high safety factor", "Concrete's weakness in tension"], ans: 3, topic: "Building Construction" },
    { q: "What is the golden rule of composite structural elements like a Flitch plate girder?", opts: ["All elements of a composite material must react together to carry the load.", "The steel must always bear the tension.", "The safety factor must be reduced in a fire.", "They are immune to pyrolytic decomposition."], ans: 0, topic: "Building Construction" },
    { q: "The load-carrying capacity of a beam increases by the square of its:", opts: ["Width", "Length", "Depth", "Weight"], ans: 2, topic: "Building Construction" },
    { q: "When a simple beam deflects downward under a load, the material at the bottom of the beam is elongating and is in:", opts: ["Tension", "Compression", "Torsion", "Shear"], ans: 0, topic: "Building Construction" },
    { q: "A beam that is supported and rigidly held at only one end, projecting out into space like an exterior balcony, is a:", opts: ["Continuous Beam", "Suspended Beam", "Simple Beam", "Cantilever Beam"], ans: 3, topic: "Building Construction" },
    { q: "If fire destroys the roof anchor point of a suspended beam (like a heavy theater marquee), it instantly reverts to a highly unstable:", opts: ["Axial column", "Un-designed cantilever", "Rigid connection", "Uniformly distributed load"], ans: 1, topic: "Building Construction" },
    { q: "In a standard roof truss, the top chord acts like a column laid on its side and is entirely under:", opts: ["Tension", "Compression", "Torsion", "Shear"], ans: 1, topic: "Building Construction" },
    { q: "What hidden, heat-driven process causes wood fibers to turn to charcoal and release metal gusset plates prematurely?", opts: ["Elongation", "Shear deflection", "Pyrolytic decomposition", "Thermal expansion"], ans: 2, topic: "Building Construction" },
    { q: "According to Euler's Law, if a tall column loses its mid-point brace and its effective length doubles, its load-carrying capacity instantly drops to:", opts: ["50%", "33%", "25%", "10%"], ans: 2, topic: "Building Construction" },
    { q: "In modern precast concrete tilt-slab construction, what provides the permanent bracing that stops the exterior walls from toppling outward?", opts: ["The foundation", "The roof structure", "The steel tie-rods", "The floor system"], ans: 1, topic: "Building Construction" },
    { q: "Unlike a simple beam that experiences both tension and compression, a true arch operates entirely under what force?", opts: ["Compression", "Tension", "Torsion", "Shear"], ans: 0, topic: "Building Construction" },
