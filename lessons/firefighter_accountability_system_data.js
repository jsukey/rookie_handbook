...
var lessonData = [
    ...
    },
    {
        ...
        text: `
            ...
            <p>During multistory or high-rise incidents, The lobby group supervisor collects PASSPORTS from all crews reporting to the building initially."</p>
...
var examQuestions = [
    ...
    { q: "Which of the following requires a Personnel Accountability Report (PAR)?", opts: [ "The arrival of the first engine company", "The establishment of a water supply", "The donning of SCBA facepieces", "Any change from offensive to defensive mode of operations"], ans: 3, topic: "Firefighter Accountability System" },
    ...
    { q: "Who is responsible for staying with his/her crew at all times and ensuring their name tag is on the PASSPORT?", opts: ["FIREFIGHTER", "BART SIMPSON", "COMMAND", "ACCOUNTABILITY OFFICER"], ans: 0, topic: "Firefighter Accountability System" },
