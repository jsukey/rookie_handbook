...
const examQuestions = [
    { q: "What is the purpose of the PASSPORT system for an Incident Commander?", opts: ["A fast and efficient means to account for all personnel working in the hazard zone", "A method for tracking water supply resources", "A system for logging apparatus maintenance", "A tool for dispatching mutual aid"], ans: 0 },
    { q: "Which of the following describes a hazard zone?", opts: ["An area that requires an SCBA, a charged hoseline and protective clothing", "The rehab sector established at an incident", "The staging area for incoming apparatus", "The command post location"], ans: 0 },
    { q: "Who is responsible for complying with the personnel accountability guideline?", opts: ["All personnel", "Only command staff", "Only interior structural firefighters", "Only mutual aid responders"], ans: 0 },
    { q: "What happens if a radio fails while in the hazard zone?", opts: ["The crew will exit unless there is another working radio with the crew", "The crew splits up to find a replacement radio", "The crew remains inside and uses hand signals", "The crew continues without communication"], ans: 0 },
    ...
    { q: "How often shall all PASSPORTS and status equipment be inspected?", opts: ["At least once annually", "Monthly", "Weekly", "After every incident"], ans: 0 },
    { q: "What must a Company Officer do if they enter a hazard zone with a partial crew?", opts: ["Remove name tags of those members not entering the hazard zone", "Leave the PASSPORT exactly as it is", "Create a completely new PASSPORT card", "Leave the PASSPORT in the cab untouched"], ans: 0 },
    { q: "Who manages PASSPORTS as Command implements divisions or groups, but Supervisors do not enter the hazard zone?", opts: ["Supervisors will manage PASSPORTS", "The dispatcher will manage PASSPORTS", "The safety officer takes over all PASSPORTS", "The personnel must carry their own PASSPORTS"], ans: 0 },
    { q: "When is the PASSPORT system mandated for implementation?", opts: ["For all incidents involving use of mutual aid", "For every medical call", "Only during high-rise fires", "Only during trench rescues"], ans: 0 },
    { q: "Where must PASSPORTS be maintained during an incident?", opts: ["At the point of entry to the hazard zone", "Inside the hazard zone with the crew", "Exclusively at the command post", "Left on the apparatus dash at all times"], ans: 0 },
    { q: "During multistory or high-rise incidents, who collects PASSPORTS from all crews reporting to the building initially?", opts: ["A Lobby Group", "The roof division", "The rapid intervention team", "The initial apparatus operator only"], ans: 0 },
    { q: "What defines a Personnel Accountability Report (PAR) for a Division/Group Supervisor?", opts: ["An accounting for all crew members of all companies assigned to their area", "A visual check of only their immediate crew", "A radio check of the primary dispatch channel", "A count of the remaining air supply for interior crews"], ans: 0 },
    { q: "Which of the following requires a Personnel Accountability Report (PAR)?", opts: ["Any change from offensive to defensive mode of operations", "The arrival of the first engine company", "The establishment of a water supply", "The donning of SCBA facepieces"], ans: 0 },
    { q: "How long is PASSPORT accountability maintained?", opts: ["Through a report of Fire Under Control", "Until the first crew exits the building", "For the first 30 minutes of the incident only", "Until the primary search is complete"], ans: 0 },
    { q: "What is the assumption for an absent or unaccounted member of any crew?", opts: ["Automatically assumed lost or trapped in the hazard zone", "Assumed to be retrieving tools from the apparatus", "Assumed to be safe in the rehab area", "Assumed to have reported to the command post"], ans: 0 },
    { q: "What must Command dispatch for any report of a missing firefighter?", opts: ["The Rapid Intervention Team (RIT)", "The hazardous materials team", "The public information officer", "The fire investigator"], ans: 0 },
    { q: "Who is responsible for tracking the location of all crews at an incident?", opts: ["COMMAND", "FIREFIGHTER", "DISPATCHER", "OPERATOR"], ans: 0 },
    ...
    { q: "Who works closely with Accountability Officers to ensure accurate PASSPORTS and tracking of crews?", opts: ["DIVISION SUPERVISOR", "FIREFIGHTER", "WATER SUPPLY OFFICER", "DISPATCHER"], ans: 0 },
    { q: "What size is the status board on an engine, ladder, or rescue?", opts: ["8 x 12 inches", "16 x 12 inches", "2 x 4 inches", "4 x 6 inches"], ans: 0 },
    { q: "Who is responsible for staying with his/her crew at all times and ensuring their name tag is on the PASSPORT?", opts: ["FIREFIGHTER", "COMPANY OFFICER", "COMMAND", "ACCOUNTABILITY OFFICER"], ans: 0 },
    { q: "What happens to strategy when there is a report of a missing firefighter?", opts: ["Simultaneously, adjust all on-scene strategies to a priority search and rescue effort", "Strategies remain the same but speed is increased", "All operations cease immediately until the firefighter is found", "Strategy strictly shifts to defensive operations to protect the remaining crews"], ans: 0 },
    { q: "When crews report an ALL CLEAR, what must company officers ensure they have?", opts: ["A PAR for their members", "A secondary hose line in place", "A new PASSPORT card", "A confirmed water supply"], ans: 0 },
    { q: "Where are the three individual name tags affixed on a firefighter?", opts: ["On the underside of their helmet", "On the left breast of their turnout coat", "Inside their right glove", "On their radio strap"], ans: 0 }
];
