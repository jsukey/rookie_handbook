const currentLessonName = "Air Managment";
const lessonData = [
    {
        id: 0,
...
const examQuestions = [
    { q: "What percentage of the SCBA air supply is designated for working and exiting?", opts: ["33%", "50%", "66%", "75%"], ans: 2, coaching: "The initial 66% of the air supply is for working and exiting." },
    { q: "What is the minimum cylinder pressure required to enter a hazardous atmosphere?", opts: ["4000 psi", "4500 psi", "5000 psi", "5500 psi"], ans: 2, coaching: "Members must have a minimum of 5000 psi in their cylinder in order to make entry into a hazardous atmosphere." },
    { q: "What HUD light activation prompts an officer to alert the Supervisor that the crew is at 50% air level?", opts: ["One solid green light", "Two flashing amber lights", "One flashing red light", "Three solid amber lights"], ans: 1, coaching: "When the first member gets a 50% HUD light activation (two flashing amber lights), the officer must alert the Supervisor." },
    { q: "At approximately what time interval will crews working in the Hazard Zone be notified by command or accountability?", opts: ["5 minutes", "10 minutes", "15 minutes", "20 minutes"], ans: 1, coaching: "Crews working in the Hazard Zone will be notified when they have reached approximately 10 minutes." },
    { q: "After how many cylinders must a firefighter go to rehab?", opts: ["One cylinder", "Two cylinders", "Three cylinders", "Four cylinders"], ans: 1, coaching: "This creates a two-cylinder rotation for firefighters, after which the firefighter MUST go to rehab." },
    { q: "How should an unaccompanied ringing low air alarm in the Hazard Zone be treated?", opts: ["With routine caution", "As a standard exit reminder", "With the same urgency as a Mayday", "As an equipment malfunction"], ans: 2, coaching: "That bell should be considered an emergency alarm and treated with the same urgency as a Mayday." },
    { q: "What is the rule regarding facial hair and respiratory protection?", opts: ["It must be trimmed to less than 1/4 inch", "No facial hair is allowed between the sealing surface and the face", "Mustaches are strictly prohibited", "Facial hair is acceptable if petroleum jelly is used"], ans: 1, coaching: "Members shall ensure that they have no facial hair between the sealing surface of the facepiece and the face." },
    { q: "When is the use of a full-face respirator prohibited?", opts: ["During wildland fires", "During vehicle extrication", "When there is a potential for an oxygen-deficient atmosphere", "When bloodborne pathogens are suspected"], ans: 2, coaching: "Full-face respirators shall not be used when there is a potential for an oxygen-deficient atmosphere." },
    ...
    { q: "What size particulate contaminants do N95 masks protect against?", opts: ["0.1 microns or larger", "0.3 microns or larger", "0.5 microns or larger", "1.0 microns or larger"], ans: 1, coaching: "N95 masks protect against particulate contaminants that are 0.3 microns or larger." },
    { q: "How often must SCBA fit testing be repeated after the initial test?", opts: ["Every 6 months", "Annually", "Every 2 years", "Every 3 years"], ans: 1, coaching: "SCBAs shall be quantitatively fit tested before use and annually thereafter." },
    { q: "In what pressure mode must fit testing be done?", opts: ["Positive-pressure mode", "Negative-pressure mode", "Neutral-pressure mode", "Variable-pressure mode"], ans: 1, coaching: "Fit testing is to be done only in a negative-pressure mode." },
    { q: "Who reviews the respirator medical evaluation questionnaires?", opts: ["The Training Officer", "The Fire Chief", "A Physician or Licensed Health Care Professional (PLHCP)", "The Company Officer"], ans: 2, coaching: "The questionnaires will be reviewed by a PLHCP selected by the Department." },
    { q: "How often must frontline SCBA be physically inspected?", opts: ["Prior to each shift", "Once a week", "Once a month", "After each alarm"], ans: 0, coaching: "Prior to each shift, members are required to physically inspect and operate all SCBA and respirators." },
    { q: "If SCBA equipment is not in daily use, how often should it be inspected?", opts: ["At least once a week", "Once every two weeks", "Monthly", "Annually"], ans: 0, coaching: "If the equipment is not in daily use, it should be inspected at least once a week and after each cleaning." },
    { q: "Who is in charge of the department's SCBA program?", opts: ["The Shift Commander", "The Captain assigned to Number 3 Fire Station", "The designated Safety Officer", "The Training Division"], ans: 1, coaching: "The Captain assigned to Number 3 Fire Station shall be in charge of this department's SCBA program." },
    { q: "When should members clean and sanitize SCBA and respirators?", opts: ["After each use", "Once a week", "During the annual service", "Only when visibly soiled"], ans: 0, coaching: "Members should thoroughly clean and sanitize all SCBA and respirators after each use." },
    ...
    { q: "Respirators must not be stored in lockers or vehicles unless what condition is met?", opts: ["They are inspected daily", "They are stored in individual containers and protected from damage", "They are kept in a temperature-controlled cab", "They are assigned to a chief officer"], ans: 1, coaching: "Respirators shall not be stored in lockers or vehicles unless the respirators are stored in individual containers and are protected from damage." },
    { q: "Who must perform the annual SCBA flow testing?", opts: ["A certified SCBA technician", "The station captain", "The safety officer", "A designated senior firefighter"], ans: 0, coaching: "All annual flow testing must be performed by a certified SCBA technician." }
];
